...
*****************************************************************************/
/*int s1=0;
Listenerv::Listenerv(int argc, char** argv ) :
...
*/
/****/
/*void Listener::subimage()
{
    s=1;
}*/
/*
void Listenerv::ros_comms_init() {
	ros::NodeHandle n;
    //ros::spin();
...
/*	image_sub_ = it_.subscribe("/openni2_camera/rgb/image_raw", 1,
    ...
    image_sub_ = it_.subscribe("/usb_cam/image_raw", 1,
          &Listenerv::chatterCallback, this);
	//chatter_subscriber = n.subscribe("chatter", 1000, &Listener::chatterCallback, this);
}
QImage Listenerv::cvtCvMat2QImage(const cv::Mat & image)
{
	QImage qtemp;
...
void Listenerv::chatterCallback(const sensor_msgs::ImageConstPtr& msg1){
...
//	ROS_INFO("I heard: [%s]", msg->data.c_str());
	cv_bridge::CvImagePtr cv_ptr;
	  try
        ...
        px1 = QPixmap::fromImage(cvtCvMat2QImage(cv_ptr->image));
